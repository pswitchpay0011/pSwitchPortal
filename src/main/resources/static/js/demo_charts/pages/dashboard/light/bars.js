...
var DashboardBars = function() {
    ...
    return {
        init: function() {
            _BarChart('#dmt-bars', 24, 40, true, 'elastic', 1200, 50, '#EC407A', 'hours');
            _BarChart('#abp-bars', 24, 40, true, 'elastic', 1200, 50, '#FFA726', 'goal');
			_BarChart('#aeps-bars', 24, 40, true, 'elastic', 1200, 50, 'green', 'goal');
			_BarChart('#ins-bars', 24, 40, true, 'elastic', 1200, 50, '#5C6BC0', 'goal');
